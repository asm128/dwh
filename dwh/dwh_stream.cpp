...
#include "zlib.h"
	...
	::gpk::error_t									dwh::lineDeflate								(const ::gpk::view_array<const ubyte_t>	& inflated, ::gpk::array_pod<ubyte_t>& deflated)	{
    int				ret;
	z_stream		strm												= {};
	...
	::gpk::error_t									dwh::lineInflate								(const ::gpk::view_array<ubyte_t>		& deflated, ::gpk::array_pod<ubyte_t>& inflated)	{
	z_stream																	strm											= {};
