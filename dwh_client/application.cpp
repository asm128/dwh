...
GPK_DEFINE_APPLICATION_ENTRY_POINT(::gme::SApplication, "Module Explorer");
	...
	client;
	//::gpk::SUDPClient														& clientUDP					= client.UDPClient;
	//::dwh::SSessionClient													& clientSession				= client.Client;
	return 0;
}
	...
	::gpk::tcpipAddress(32766, 0, ::gpk::TRANSPORT_PROTOCOL_UDP, app.Client.UDPClient.AddressConnect);
	::gpk::clientConnect(app.Client.UDPClient);
	return 0; 
}
